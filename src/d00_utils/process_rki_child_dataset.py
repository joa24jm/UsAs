...
def load_rki_child_dataset(filepath: str = "data/d01_raw/ch/22-07-01_rki_children_followup.csv",
...
def main():
    ...
    rki_child_dataset.to_csv("data/d02_processed/rki_child.csv", index=False)
